...
<head>
    ...
    <style>
        ...
        #img-preview, #sub-img-preview, #sub-file {
            display: none;
        }
    </style>
    ...
    <div class="container">
        <div class="card shadow-sm p-3">
            <fieldset>
                <h2>게시글 작성</h2>
                <hr/>
                <form action="/input.do" class="needs-validation" method="POST" enctype="multipart/form-data"
                      novalidate>
                    <!-- 제목과 업로드할 게시판 입력 -->
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="sboard" name="board" class="form-control">
                                <option selected value="1">자유 게시판</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="photo-preview">
                            <img src="#" id="img-preview" class="card-img-top" alt="Image"/>
                            <img src="#" id="sub-img-preview" class="card-img-top my-2" alt="Image"/>
                        </div>
                        <div class="form-group custom-file">
                            <input type="file" class="custom-file-input" id="simg" name="img" required
                                   accept="image/*"/>
                            <small class="form-text text-muted custom-file-label" data-browse="업로드">업로드할 사진을 선택해
                                주세요.</small>
                        </div>
...
<script>
    ...
    fileInput.addEventListener("change", (event) => {
        ...
        document.querySelector("#sub-file").style.display = "block";
