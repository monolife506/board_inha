...
<nav id="navbar"
    ...
    <div id="navbar-content"
         class="collapse navbar-collapse align-content-stretch justify-content-between">
        <ul class="navbar-nav">
            <li class="nav-item">
        ...
        <ul class="nav navbar-nav flex-row justify-content-md-start flex-nowrap">
            <li>
                ...
                <!-- Logout -->
                <!--
                    <span class="navbar-text mr-2">안녕하세요 Username님.</span>
...
<div id="sidebar" class="col-fixed navbar navbar-dark bg-dark px-2">
    ...
    <div class="justify-content-center">
        <ul>
            <li>
                <p class="navbar-text mr-2">안녕하세요 Username님.</p>
                <a href="/logout.do" class="btn btn-danger">로그아웃</a>
            </li>
        </ul>
    </div>
...
<div id="content" class="container">
    ...
    <div class="card-wrapper row m-nx-5">
        <div class="card col-lg m-2 shadow-sm">
            <div class="card-body">
